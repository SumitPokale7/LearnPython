...
if direction == "left":
    boat = input('You\'ve come to a lake. There is an island in the middle of the lake. '
        'Type "wait" to wait for a boat. Type "swim" to swim across.\n').lower()
    if boat == "wait":
        print()
    else:
        print("You got attacked by an crocodile. Game Over.")
    door = input('You arrive at the island unharmed. There is house with 3 door. One red, one yellom one blue.'
